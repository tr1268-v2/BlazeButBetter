...
static_assert(alignof(Uv3_PlayerCameraModeTargetingAssault_C) == 0x000004, "Wrong alignment on Uv3_PlayerCameraModeTargetingAssault_C");
static_assert(sizeof(Uv3_PlayerCameraModeTargetingAssault_C) == 0x0000B4, "Wrong size on Uv3_PlayerCameraModeTargetingAssault_C");
