...
static_assert(alignof(UGET_Cooldown_C) == 0x000004, "Wrong alignment on UGET_Cooldown_C");
static_assert(sizeof(UGET_Cooldown_C) == 0x000368, "Wrong size on UGET_Cooldown_C");
