...
void AMusicManager_C::PlayDefaultMusic()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("MusicManager_C", "PlayDefaultMusic");
...
// (Event, Public, BlueprintEvent)
// Parameters:
// EFortDayPhase                           CurrentDayPhase_0                                      (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
// EFortDayPhase                           PreviousDayPhase                                       (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
