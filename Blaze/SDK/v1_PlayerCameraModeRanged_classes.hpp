...
static_assert(alignof(Uv1_PlayerCameraModeRanged_C) == 0x000004, "Wrong alignment on Uv1_PlayerCameraModeRanged_C");
static_assert(sizeof(Uv1_PlayerCameraModeRanged_C) == 0x0000B4, "Wrong size on Uv1_PlayerCameraModeRanged_C");
