...
static_assert(alignof(AHBOnboardingFlow_C) == 0x000004, "Wrong alignment on AHBOnboardingFlow_C");
static_assert(sizeof(AHBOnboardingFlow_C) == 0x0002AC, "Wrong size on AHBOnboardingFlow_C");
static_assert(offsetof(AHBOnboardingFlow_C, UberGraphFrame) == 0x000240, "Member 'AHBOnboardingFlow_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AHBOnboardingFlow_C, DefaultSceneRoot) == 0x000244, "Member 'AHBOnboardingFlow_C::DefaultSceneRoot' has a wrong offset!");
static_assert(offsetof(AHBOnboardingFlow_C, PlayerController) == 0x000248, "Member 'AHBOnboardingFlow_C::PlayerController' has a wrong offset!");
static_assert(offsetof(AHBOnboardingFlow_C, QuestManager) == 0x00024C, "Member 'AHBOnboardingFlow_C::QuestManager' has a wrong offset!");
static_assert(offsetof(AHBOnboardingFlow_C, OnboardingQuest) == 0x000250, "Member 'AHBOnboardingFlow_C::OnboardingQuest' has a wrong offset!");
static_assert(offsetof(AHBOnboardingFlow_C, OnboardingAfterOutpostQuest) == 0x000254, "Member 'AHBOnboardingFlow_C::OnboardingAfterOutpostQuest' has a wrong offset!");
static_assert(offsetof(AHBOnboardingFlow_C, CompleteZoneObjective) == 0x000258, "Member 'AHBOnboardingFlow_C::CompleteZoneObjective' has a wrong offset!");
static_assert(offsetof(AHBOnboardingFlow_C, NameHomebaseObjective) == 0x000264, "Member 'AHBOnboardingFlow_C::NameHomebaseObjective' has a wrong offset!");
static_assert(offsetof(AHBOnboardingFlow_C, BuildHeroBuildingObjective) == 0x000270, "Member 'AHBOnboardingFlow_C::BuildHeroBuildingObjective' has a wrong offset!");
static_assert(offsetof(AHBOnboardingFlow_C, RecruitHeroObjective) == 0x00027C, "Member 'AHBOnboardingFlow_C::RecruitHeroObjective' has a wrong offset!");
static_assert(offsetof(AHBOnboardingFlow_C, OnboardingQuestItem) == 0x000288, "Member 'AHBOnboardingFlow_C::OnboardingQuestItem' has a wrong offset!");
static_assert(offsetof(AHBOnboardingFlow_C, NotificationPadding) == 0x00028C, "Member 'AHBOnboardingFlow_C::NotificationPadding' has a wrong offset!");
static_assert(offsetof(AHBOnboardingFlow_C, PlaySatelliteCineObjective) == 0x00029C, "Member 'AHBOnboardingFlow_C::PlaySatelliteCineObjective' has a wrong offset!");
static_assert(offsetof(AHBOnboardingFlow_C, ShowNewsToken) == 0x0002A8, "Member 'AHBOnboardingFlow_C::ShowNewsToken' has a wrong offset!");
