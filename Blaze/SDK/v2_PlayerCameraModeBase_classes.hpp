...
static_assert(alignof(Uv2_PlayerCameraModeBase_C) == 0x000004, "Wrong alignment on Uv2_PlayerCameraModeBase_C");
static_assert(sizeof(Uv2_PlayerCameraModeBase_C) == 0x0000B4, "Wrong size on Uv2_PlayerCameraModeBase_C");
