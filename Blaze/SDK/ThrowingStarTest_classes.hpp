...
static_assert(alignof(UThrowingStarTest_C) == 0x000004, "Wrong alignment on UThrowingStarTest_C");
static_assert(sizeof(UThrowingStarTest_C) == 0x000030, "Wrong size on UThrowingStarTest_C");
