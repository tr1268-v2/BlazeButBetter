...
static_assert(alignof(AB_Melee_Impact_Generic_C) == 0x000004, "Wrong alignment on AB_Melee_Impact_Generic_C");
static_assert(sizeof(AB_Melee_Impact_Generic_C) == 0x000664, "Wrong size on AB_Melee_Impact_Generic_C");
