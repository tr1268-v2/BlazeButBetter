...
static_assert(alignof(Uv3_PlayerCameraModeMelee_C) == 0x000004, "Wrong alignment on Uv3_PlayerCameraModeMelee_C");
static_assert(sizeof(Uv3_PlayerCameraModeMelee_C) == 0x0000B4, "Wrong size on Uv3_PlayerCameraModeMelee_C");
