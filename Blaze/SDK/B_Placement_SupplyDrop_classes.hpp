...
// 0x000C (0x0368 - 0x035C)
class AB_Placement_SupplyDrop_C final : public AFortDecoPreview
{
public:
...
public:
	void ExecuteUbergraph_B_Placement_SupplyDrop(int32 EntryPoint);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"B_Placement_SupplyDrop_C">();
	}
	static class AB_Placement_SupplyDrop_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<AB_Placement_SupplyDrop_C>();
	}
};
static_assert(alignof(AB_Placement_SupplyDrop_C) == 0x000004, "Wrong alignment on AB_Placement_SupplyDrop_C");
static_assert(sizeof(AB_Placement_SupplyDrop_C) == 0x000368, "Wrong size on AB_Placement_SupplyDrop_C");
static_assert(offsetof(AB_Placement_SupplyDrop_C, UberGraphFrame) == 0x00035C, "Member 'AB_Placement_SupplyDrop_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AB_Placement_SupplyDrop_C, Box1) == 0x000360, "Member 'AB_Placement_SupplyDrop_C::Box1' has a wrong offset!");
static_assert(offsetof(AB_Placement_SupplyDrop_C, Good) == 0x000364, "Member 'AB_Placement_SupplyDrop_C::Good' has a wrong offset!");
