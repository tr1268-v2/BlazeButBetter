...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// const struct FLinearColor&              VSpawnColor                                            (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
...
void APlayerPawn_Outlander_C::OnBaseChanged(class AActor* NewBase)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("PlayerPawn_Outlander_C", "OnBaseChanged");

	Params::PlayerPawn_Outlander_C_OnBaseChanged Parms{};
