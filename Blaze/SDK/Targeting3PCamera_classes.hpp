...
static_assert(alignof(UTargeting3PCamera_C) == 0x000004, "Wrong alignment on UTargeting3PCamera_C");
static_assert(sizeof(UTargeting3PCamera_C) == 0x000110, "Wrong size on UTargeting3PCamera_C");
