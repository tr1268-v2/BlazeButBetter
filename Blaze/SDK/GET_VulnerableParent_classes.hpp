...
static_assert(alignof(UGET_VulnerableParent_C) == 0x000004, "Wrong alignment on UGET_VulnerableParent_C");
static_assert(sizeof(UGET_VulnerableParent_C) == 0x000368, "Wrong size on UGET_VulnerableParent_C");
