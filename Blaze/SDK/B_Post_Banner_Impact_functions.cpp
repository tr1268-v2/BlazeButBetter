...
#include "B_Post_Banner_Impact_classes.hpp"
#include "B_Post_Banner_Impact_parameters.hpp"
...
void AB_Post_Banner_Impact_C::ExecuteUbergraph_B_Post_Banner_Impact(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("B_Post_Banner_Impact_C", "ExecuteUbergraph_B_Post_Banner_Impact");

	Params::B_Post_Banner_Impact_C_ExecuteUbergraph_B_Post_Banner_Impact Parms{};
...
void AB_Post_Banner_Impact_C::SpawnPostFX(float PostFX_BoxScaleDyn, const struct FVector& PostFX_CamShakeLoc, bool PostFX_UseCamShake, float PostFX_DeactivateDelay)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("B_Post_Banner_Impact_C", "SpawnPostFX");

	Params::B_Post_Banner_Impact_C_SpawnPostFX Parms{};
...
void AB_Post_Banner_Impact_C::Timeline_0__UpdateFunc()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("B_Post_Banner_Impact_C", "Timeline_0__UpdateFunc");
...
void AB_Post_Banner_Impact_C::Timeline_0__FinishedFunc()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("B_Post_Banner_Impact_C", "Timeline_0__FinishedFunc");
...
void AB_Post_Banner_Impact_C::UserConstructionScript()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("B_Post_Banner_Impact_C", "UserConstructionScript");
