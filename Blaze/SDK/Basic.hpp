...
namespace Offsets
{
	constexpr int32 GObjects          = 0x02DC3AAC;
	constexpr int32 AppendString      = 0x0090B660;
	constexpr int32 GNames            = 0x02DBC5A8;
	constexpr int32 GWorld            = 0x02E68BEC;
	constexpr int32 ProcessEvent      = 0x009A9E70;
	constexpr int32 ProcessEventIdx   = 0x00000034;
}
...
{
public:
	class UObject*                                Object;                                            // 0x0000(0x0004)(NOT AUTO-GENERATED PROPERTY)
	uint8                                         Pad_4[0x8];                                        // 0x0004(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FUObjectItem) == 0x000004, "Wrong alignment on FUObjectItem");
static_assert(sizeof(FUObjectItem) == 0x00000C, "Wrong size on FUObjectItem");
...
public:
	...
	struct FUObjectItem*                          Objects;                                           // 0x0000(0x0004)(NOT AUTO-GENERATED PROPERTY)
	int32                                         MaxElements;                                       // 0x0004(0x0004)(NOT AUTO-GENERATED PROPERTY)
	int32                                         NumElements;                                       // 0x0008(0x0004)(NOT AUTO-GENERATED PROPERTY)
...
static_assert(alignof(TUObjectArray) == 0x000004, "Wrong alignment on TUObjectArray");
static_assert(sizeof(TUObjectArray) == 0x00000C, "Wrong size on TUObjectArray");
static_assert(offsetof(TUObjectArray, Objects) == 0x000000, "Member 'TUObjectArray::Objects' has a wrong offset!");
static_assert(offsetof(TUObjectArray, MaxElements) == 0x000004, "Member 'TUObjectArray::MaxElements' has a wrong offset!");
static_assert(offsetof(TUObjectArray, NumElements) == 0x000008, "Member 'TUObjectArray::NumElements' has a wrong offset!");
...
public:
	...
	std::string GetRawString() const
	{
		...
		InSDKUtils::CallGameFunction(reinterpret_cast<void(__thiscall*)(const FName*, FString&)>(AppendString), this, TempString);
...
public:
	...
	class FString                                 TextSource;                                        // 0x0014(0x000C)(NOT AUTO-GENERATED PROPERTY)
};
static_assert(alignof(FTextData) == 0x000004, "Wrong alignment on FTextData");
static_assert(sizeof(FTextData) == 0x000020, "Wrong size on FTextData");
static_assert(offsetof(FTextData, TextSource) == 0x000014, "Member 'FTextData::TextSource' has a wrong offset!");
}
...
{
public:
	class FTextImpl::FTextData*                   TextData;                                          // 0x0000(0x0004)(NOT AUTO-GENERATED PROPERTY)
	uint8                                         Pad_4[0x8];                                        // 0x0004(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FText) == 0x000004, "Wrong alignment on FText");
static_assert(sizeof(FText) == 0x00000C, "Wrong size on FText");
...
{
public:
	class FString                                 AssetLongPathname;                                 // 0x0000(0x000C)(NOT AUTO-GENERATED PROPERTY)
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FSoftObjectPath) == 0x000004, "Wrong alignment on FSoftObjectPath");
...
{
public:
	UObject*                                      ObjectPointer;                                     // 0x0000(0x0004)(NOT AUTO-GENERATED PROPERTY)
	void*                                         InterfacePointer;                                  // 0x0004(0x0004)(NOT AUTO-GENERATED PROPERTY)
...
static_assert(alignof(FScriptInterface) == 0x000004, "Wrong alignment on FScriptInterface");
static_assert(sizeof(FScriptInterface) == 0x000008, "Wrong size on FScriptInterface");
static_assert(offsetof(FScriptInterface, ObjectPointer) == 0x000000, "Member 'FScriptInterface::ObjectPointer' has a wrong offset!");
static_assert(offsetof(FScriptInterface, InterfacePointer) == 0x000004, "Member 'FScriptInterface::InterfacePointer' has a wrong offset!");
...
{
public:
	TArray<FScriptDelegate>                       InvocationList;                                    // 0x0000(0x000C)(NOT AUTO-GENERATED PROPERTY)
};
