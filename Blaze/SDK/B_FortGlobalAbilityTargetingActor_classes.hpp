...
static_assert(alignof(AB_FortGlobalAbilityTargetingActor_C) == 0x000004, "Wrong alignment on AB_FortGlobalAbilityTargetingActor_C");
static_assert(sizeof(AB_FortGlobalAbilityTargetingActor_C) == 0x000240, "Wrong size on AB_FortGlobalAbilityTargetingActor_C");
