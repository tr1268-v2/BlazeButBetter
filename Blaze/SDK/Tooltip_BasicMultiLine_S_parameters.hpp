...
public:
	...
	class APlayerController*                      CallFunc_GetOwningPlayer_ReturnValue;              // 0x0018(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor)
	class UTooltipStatWidget_C*                   CallFunc_Create_ReturnValue;                       // 0x001C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor)
	int32                                         CallFunc_Add_IntInt_ReturnValue;                   // 0x0020(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor)
	class FText                                   CallFunc_Array_Get_Item;                           // 0x0024(0x000C)()
	class UVerticalBoxSlot*                       CallFunc_AddChildToVerticalBox_ReturnValue;        // 0x0030(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor)
	struct FTooltipStat                           K2Node_MakeStruct_TooltipStat;                     // 0x0034(0x001C)()
	int32                                         CallFunc_Array_Length_ReturnValue;                 // 0x0050(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_Less_IntInt_ReturnValue;                  // 0x0054(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
static_assert(alignof(Tooltip_BasicMultiLine_S_C_Get_Body_Text) == 0x000004, "Wrong alignment on Tooltip_BasicMultiLine_S_C_Get_Body_Text");
static_assert(sizeof(Tooltip_BasicMultiLine_S_C_Get_Body_Text) == 0x000058, "Wrong size on Tooltip_BasicMultiLine_S_C_Get_Body_Text");
...
static_assert(offsetof(Tooltip_BasicMultiLine_S_C_Get_Body_Text, K2Node_MakeStruct_Margin) == 0x000004, "Member 'Tooltip_BasicMultiLine_S_C_Get_Body_Text::K2Node_MakeStruct_Margin' has a wrong offset!");
static_assert(offsetof(Tooltip_BasicMultiLine_S_C_Get_Body_Text, Temp_int_Loop_Counter_Variable) == 0x000014, "Member 'Tooltip_BasicMultiLine_S_C_Get_Body_Text::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(Tooltip_BasicMultiLine_S_C_Get_Body_Text, CallFunc_GetOwningPlayer_ReturnValue) == 0x000018, "Member 'Tooltip_BasicMultiLine_S_C_Get_Body_Text::CallFunc_GetOwningPlayer_ReturnValue' has a wrong offset!");
static_assert(offsetof(Tooltip_BasicMultiLine_S_C_Get_Body_Text, CallFunc_Create_ReturnValue) == 0x00001C, "Member 'Tooltip_BasicMultiLine_S_C_Get_Body_Text::CallFunc_Create_ReturnValue' has a wrong offset!");
static_assert(offsetof(Tooltip_BasicMultiLine_S_C_Get_Body_Text, CallFunc_Add_IntInt_ReturnValue) == 0x000020, "Member 'Tooltip_BasicMultiLine_S_C_Get_Body_Text::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Tooltip_BasicMultiLine_S_C_Get_Body_Text, CallFunc_Array_Get_Item) == 0x000024, "Member 'Tooltip_BasicMultiLine_S_C_Get_Body_Text::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(Tooltip_BasicMultiLine_S_C_Get_Body_Text, CallFunc_AddChildToVerticalBox_ReturnValue) == 0x000030, "Member 'Tooltip_BasicMultiLine_S_C_Get_Body_Text::CallFunc_AddChildToVerticalBox_ReturnValue' has a wrong offset!");
static_assert(offsetof(Tooltip_BasicMultiLine_S_C_Get_Body_Text, K2Node_MakeStruct_TooltipStat) == 0x000034, "Member 'Tooltip_BasicMultiLine_S_C_Get_Body_Text::K2Node_MakeStruct_TooltipStat' has a wrong offset!");
static_assert(offsetof(Tooltip_BasicMultiLine_S_C_Get_Body_Text, CallFunc_Array_Length_ReturnValue) == 0x000050, "Member 'Tooltip_BasicMultiLine_S_C_Get_Body_Text::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(Tooltip_BasicMultiLine_S_C_Get_Body_Text, CallFunc_Less_IntInt_ReturnValue) == 0x000054, "Member 'Tooltip_BasicMultiLine_S_C_Get_Body_Text::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
...
static_assert(alignof(Tooltip_BasicMultiLine_S_C_Get_Header_Text) == 0x000004, "Wrong alignment on Tooltip_BasicMultiLine_S_C_Get_Header_Text");
static_assert(sizeof(Tooltip_BasicMultiLine_S_C_Get_Header_Text) == 0x00000C, "Wrong size on Tooltip_BasicMultiLine_S_C_Get_Header_Text");
...
static_assert(alignof(Tooltip_BasicMultiLine_S_C_Get_Icon_Brush) == 0x000004, "Wrong alignment on Tooltip_BasicMultiLine_S_C_Get_Icon_Brush");
static_assert(sizeof(Tooltip_BasicMultiLine_S_C_Get_Icon_Brush) == 0x0000E8, "Wrong size on Tooltip_BasicMultiLine_S_C_Get_Icon_Brush");
...
static_assert(offsetof(Tooltip_BasicMultiLine_S_C_Get_Icon_Brush, CallFunc_MakeBrushFromAsset_ReturnValue) == 0x000074, "Member 'Tooltip_BasicMultiLine_S_C_Get_Icon_Brush::CallFunc_MakeBrushFromAsset_ReturnValue' has a wrong offset!");
