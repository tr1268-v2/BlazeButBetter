...
static_assert(alignof(UGCNS_TestAntiMaterial_C) == 0x000004, "Wrong alignment on UGCNS_TestAntiMaterial_C");
static_assert(sizeof(UGCNS_TestAntiMaterial_C) == 0x000044, "Wrong size on UGCNS_TestAntiMaterial_C");
