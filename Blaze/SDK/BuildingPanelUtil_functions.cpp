...
#include "BuildingPanelUtil_classes.hpp"
#include "BuildingPanelUtil_parameters.hpp"
...
void UBuildingPanelUtil_C::InitItemWidget(class UFortItemWidget* Widget, class UFortItem* Item, class UObject* __WorldContext)
{
	...
	if (Func == nullptr)
		Func = StaticClass()->GetFunction("BuildingPanelUtil_C", "InitItemWidget");

	Params::BuildingPanelUtil_C_InitItemWidget Parms{};
...
void UBuildingPanelUtil_C::EnsureIconBrush(const struct FFortMultiSizeBrush& Multi_size_Brush, class UObject* __WorldContext, struct FSlateBrush* Brush)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("BuildingPanelUtil_C", "EnsureIconBrush");

	Params::BuildingPanelUtil_C_EnsureIconBrush Parms{};
...
// class UObject*                          __WorldContext                                         (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
// class FText*                            Bonus_Text                                             (Parm, OutParm)

void UBuildingPanelUtil_C::Get_Worker_Bonus_Text(class UHomeBaseWorker* Worker, class UObject* __WorldContext, class FText* Bonus_Text)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("BuildingPanelUtil_C", "Get Worker Bonus Text");

	Params::BuildingPanelUtil_C_Get_Worker_Bonus_Text Parms{};
	...
	if (Bonus_Text != nullptr)
		*Bonus_Text = std::move(Parms.Bonus_Text);
}
...
// Parameters:
// const struct FLinearColor&              Base_Color                                             (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
// const struct FLinearColor&              Hightlight_Color                                       (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
// class UObject*                          __WorldContext                                         (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
// struct FLinearColor*                    Current_Color                                          (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)

void UBuildingPanelUtil_C::Calculate_Current_Pulsing_Highlight_Color(const struct FLinearColor& Base_Color, const struct FLinearColor& Hightlight_Color, class UObject* __WorldContext, struct FLinearColor* Current_Color)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("BuildingPanelUtil_C", "Calculate Current Pulsing Highlight Color");

	Params::BuildingPanelUtil_C_Calculate_Current_Pulsing_Highlight_Color Parms{};
...
void UBuildingPanelUtil_C::Get_Traits_Of_Workers(TArray<class UFortWorker*>& Workers, class UObject* __WorldContext, struct FGameplayTagContainer* Chief_Personality, struct FGameplayTagContainer* Crew_Personalities, struct FGameplayTagContainer* Crew_Set_Bonuses)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("BuildingPanelUtil_C", "Get Traits Of Workers");

	Params::BuildingPanelUtil_C_Get_Traits_Of_Workers Parms{};
...
class FText UBuildingPanelUtil_C::Get_Attribute_Modifier_Header_Text(const struct FFortAttributeInfo& Attribute_Info, const struct FGameplayTagContainer& Required_Tags, const class FText& Required_Gameplay_Tags_Description, class UObject* __WorldContext)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("BuildingPanelUtil_C", "Get Attribute Modifier Header Text");

	Params::BuildingPanelUtil_C_Get_Attribute_Modifier_Header_Text Parms{};
