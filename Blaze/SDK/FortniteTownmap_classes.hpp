...
static_assert(alignof(AFortniteTownmap_C) == 0x000004, "Wrong alignment on AFortniteTownmap_C");
static_assert(sizeof(AFortniteTownmap_C) == 0x00024C, "Wrong size on AFortniteTownmap_C");
