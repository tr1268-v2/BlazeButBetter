...
static_assert(alignof(UCircleAroundPrimaryAssignmentGoals_Bombshell_Poison_C) == 0x000004, "Wrong alignment on UCircleAroundPrimaryAssignmentGoals_Bombshell_Poison_C");
static_assert(sizeof(UCircleAroundPrimaryAssignmentGoals_Bombshell_Poison_C) == 0x000070, "Wrong size on UCircleAroundPrimaryAssignmentGoals_Bombshell_Poison_C");
