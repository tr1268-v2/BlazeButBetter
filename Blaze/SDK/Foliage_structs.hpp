...
static_assert(offsetof(FProceduralFoliageInstance, Type) == 0x000034, "Member 'FProceduralFoliageInstance::Type' has a wrong offset!");
...
public:
	...
	TSubclassOf<class UFoliageType_InstancedStaticMesh> Type;                                              // 0x000C(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
};
static_assert(alignof(FFoliageTypeObject) == 0x000004, "Wrong alignment on FFoliageTypeObject");
static_assert(sizeof(FFoliageTypeObject) == 0x000010, "Wrong size on FFoliageTypeObject");
...
static_assert(offsetof(FFoliageTypeObject, TypeInstance) == 0x000004, "Member 'FFoliageTypeObject::TypeInstance' has a wrong offset!");
static_assert(offsetof(FFoliageTypeObject, bIsAsset) == 0x000008, "Member 'FFoliageTypeObject::bIsAsset' has a wrong offset!");
static_assert(offsetof(FFoliageTypeObject, Type) == 0x00000C, "Member 'FFoliageTypeObject::Type' has a wrong offset!");
