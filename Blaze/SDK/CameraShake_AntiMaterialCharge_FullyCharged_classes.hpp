...
static_assert(alignof(UCameraShake_AntiMaterialCharge_FullyCharged_C) == 0x000004, "Wrong alignment on UCameraShake_AntiMaterialCharge_FullyCharged_C");
static_assert(sizeof(UCameraShake_AntiMaterialCharge_FullyCharged_C) == 0x000120, "Wrong size on UCameraShake_AntiMaterialCharge_FullyCharged_C");
