...
public:
	...
	class FName                                   LayerName;                                         // 0x0004(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FLandscapeInfoLayerSettings) == 0x000004, "Wrong alignment on FLandscapeInfoLayerSettings");
static_assert(sizeof(FLandscapeInfoLayerSettings) == 0x00000C, "Wrong size on FLandscapeInfoLayerSettings");
...
static_assert(offsetof(FLandscapeInfoLayerSettings, LayerName) == 0x000004, "Member 'FLandscapeInfoLayerSettings::LayerName' has a wrong offset!");
...
static_assert(alignof(FGrassInput) == 0x000004, "Wrong alignment on FGrassInput");
...
static_assert(offsetof(FGrassInput, Input) == 0x00000C, "Member 'FGrassInput::Input' has a wrong offset!");
...
static_assert(alignof(FGrassVariety) == 0x000004, "Wrong alignment on FGrassVariety");
static_assert(sizeof(FGrassVariety) == 0x000020, "Wrong size on FGrassVariety");
static_assert(offsetof(FGrassVariety, GrassMesh) == 0x000000, "Member 'FGrassVariety::GrassMesh' has a wrong offset!");
static_assert(offsetof(FGrassVariety, GrassDensity) == 0x000004, "Member 'FGrassVariety::GrassDensity' has a wrong offset!");
static_assert(offsetof(FGrassVariety, bUseGrid) == 0x000008, "Member 'FGrassVariety::bUseGrid' has a wrong offset!");
static_assert(offsetof(FGrassVariety, PlacementJitter) == 0x00000C, "Member 'FGrassVariety::PlacementJitter' has a wrong offset!");
static_assert(offsetof(FGrassVariety, StartCullDistance) == 0x000010, "Member 'FGrassVariety::StartCullDistance' has a wrong offset!");
static_assert(offsetof(FGrassVariety, EndCullDistance) == 0x000014, "Member 'FGrassVariety::EndCullDistance' has a wrong offset!");
static_assert(offsetof(FGrassVariety, MinLOD) == 0x000018, "Member 'FGrassVariety::MinLOD' has a wrong offset!");
static_assert(offsetof(FGrassVariety, RandomRotation) == 0x00001C, "Member 'FGrassVariety::RandomRotation' has a wrong offset!");
static_assert(offsetof(FGrassVariety, AlignToSurface) == 0x00001D, "Member 'FGrassVariety::AlignToSurface' has a wrong offset!");
...
public:
	...
	uint8                                         WeightmapTextureIndex;                             // 0x0004(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         WeightmapTextureChannel;                           // 0x0005(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         GrassMapChannelIndex;                              // 0x0006(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_7[0x1];                                        // 0x0007(0x0001)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FWeightmapLayerAllocationInfo) == 0x000004, "Wrong alignment on FWeightmapLayerAllocationInfo");
static_assert(sizeof(FWeightmapLayerAllocationInfo) == 0x000008, "Wrong size on FWeightmapLayerAllocationInfo");
...
static_assert(offsetof(FWeightmapLayerAllocationInfo, WeightmapTextureIndex) == 0x000004, "Member 'FWeightmapLayerAllocationInfo::WeightmapTextureIndex' has a wrong offset!");
static_assert(offsetof(FWeightmapLayerAllocationInfo, WeightmapTextureChannel) == 0x000005, "Member 'FWeightmapLayerAllocationInfo::WeightmapTextureChannel' has a wrong offset!");
static_assert(offsetof(FWeightmapLayerAllocationInfo, GrassMapChannelIndex) == 0x000006, "Member 'FWeightmapLayerAllocationInfo::GrassMapChannelIndex' has a wrong offset!");
...
{
public:
	class ULandscapeComponent*                    ChannelUsage[0x4];                                 // 0x0000(0x0004)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FLandscapeWeightmapUsage) == 0x000004, "Wrong alignment on FLandscapeWeightmapUsage");
static_assert(sizeof(FLandscapeWeightmapUsage) == 0x000010, "Wrong size on FLandscapeWeightmapUsage");
...
struct alignas(0x04) FGizmoSelectData final
{
public:
	uint8                                         Pad_0[0x3C];                                       // 0x0000(0x003C)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FGizmoSelectData) == 0x000004, "Wrong alignment on FGizmoSelectData");
static_assert(sizeof(FGizmoSelectData) == 0x00003C, "Wrong size on FGizmoSelectData");
...
static_assert(alignof(FLandscapeLayerStruct) == 0x000004, "Wrong alignment on FLandscapeLayerStruct");
static_assert(sizeof(FLandscapeLayerStruct) == 0x000004, "Wrong size on FLandscapeLayerStruct");
...
public:
	...
	uint8                                         bCenterH : 1;                                      // 0x0010(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, NativeAccessSpecifierPublic))
	...
	uint8                                         bScaleToWidth : 1;                                 // 0x001C(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, NativeAccessSpecifierPublic))
	...
	ELandscapeSplineMeshOrientation               Orientation;                                       // 0x002C(0x0001)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ESplineMeshAxis                               ForwardAxis;                                       // 0x002D(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ESplineMeshAxis                               UpAxis;                                            // 0x002E(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2F[0x1];                                       // 0x002F(0x0001)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FLandscapeSplineMeshEntry) == 0x000004, "Wrong alignment on FLandscapeSplineMeshEntry");
static_assert(sizeof(FLandscapeSplineMeshEntry) == 0x000030, "Wrong size on FLandscapeSplineMeshEntry");
static_assert(offsetof(FLandscapeSplineMeshEntry, Mesh) == 0x000000, "Member 'FLandscapeSplineMeshEntry::Mesh' has a wrong offset!");
static_assert(offsetof(FLandscapeSplineMeshEntry, MaterialOverrides) == 0x000004, "Member 'FLandscapeSplineMeshEntry::MaterialOverrides' has a wrong offset!");
static_assert(offsetof(FLandscapeSplineMeshEntry, CenterAdjust) == 0x000014, "Member 'FLandscapeSplineMeshEntry::CenterAdjust' has a wrong offset!");
static_assert(offsetof(FLandscapeSplineMeshEntry, Scale) == 0x000020, "Member 'FLandscapeSplineMeshEntry::Scale' has a wrong offset!");
static_assert(offsetof(FLandscapeSplineMeshEntry, Orientation) == 0x00002C, "Member 'FLandscapeSplineMeshEntry::Orientation' has a wrong offset!");
static_assert(offsetof(FLandscapeSplineMeshEntry, ForwardAxis) == 0x00002D, "Member 'FLandscapeSplineMeshEntry::ForwardAxis' has a wrong offset!");
static_assert(offsetof(FLandscapeSplineMeshEntry, UpAxis) == 0x00002E, "Member 'FLandscapeSplineMeshEntry::UpAxis' has a wrong offset!");
...
static_assert(alignof(FLandscapeSplineSegmentConnection) == 0x000004, "Wrong alignment on FLandscapeSplineSegmentConnection");
static_assert(sizeof(FLandscapeSplineSegmentConnection) == 0x000010, "Wrong size on FLandscapeSplineSegmentConnection");
...
static_assert(offsetof(FLandscapeSplineSegmentConnection, TangentLen) == 0x000004, "Member 'FLandscapeSplineSegmentConnection::TangentLen' has a wrong offset!");
static_assert(offsetof(FLandscapeSplineSegmentConnection, SocketName) == 0x000008, "Member 'FLandscapeSplineSegmentConnection::SocketName' has a wrong offset!");
...
public:
	...
	uint8                                         End : 1;                                           // 0x0004(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, NativeAccessSpecifierPublic))
	uint8                                         Pad_5[0x3];                                        // 0x0005(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FLandscapeSplineConnection) == 0x000004, "Wrong alignment on FLandscapeSplineConnection");
static_assert(sizeof(FLandscapeSplineConnection) == 0x000008, "Wrong size on FLandscapeSplineConnection");
...
static_assert(sizeof(FLayerBlendInput) == 0x000078, "Wrong size on FLayerBlendInput");
...
static_assert(offsetof(FLayerBlendInput, PreviewWeight) == 0x000064, "Member 'FLayerBlendInput::PreviewWeight' has a wrong offset!");
...
static_assert(offsetof(FLayerBlendInput, ConstHeightInput) == 0x000074, "Member 'FLayerBlendInput::ConstHeightInput' has a wrong offset!");
