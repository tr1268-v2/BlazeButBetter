...
static_assert(alignof(UInputCoreTypes) == 0x000004, "Wrong alignment on UInputCoreTypes");
static_assert(sizeof(UInputCoreTypes) == 0x00001C, "Wrong size on UInputCoreTypes");
