...
static_assert(alignof(UPlayerCameraMode1P_Targeting_C) == 0x000004, "Wrong alignment on UPlayerCameraMode1P_Targeting_C");
static_assert(sizeof(UPlayerCameraMode1P_Targeting_C) == 0x0000B4, "Wrong size on UPlayerCameraMode1P_Targeting_C");
