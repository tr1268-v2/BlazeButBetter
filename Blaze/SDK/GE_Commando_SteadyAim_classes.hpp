...
static_assert(alignof(UGE_Commando_SteadyAim_C) == 0x000004, "Wrong alignment on UGE_Commando_SteadyAim_C");
static_assert(sizeof(UGE_Commando_SteadyAim_C) == 0x000368, "Wrong size on UGE_Commando_SteadyAim_C");
